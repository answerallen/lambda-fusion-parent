...
public interface ITreeDataFilter {
     ...
     * @return ig
     */
    <T> List<T> filter(List<T> target, String queryStr, Function<T, String> queryFc, Function<T, String> idFc, Function<T, String> pFullKey, Function<Collection<T>, List<T>> sort);
}
