...
public class FxMsgEvent {
    ...
    public void setTarget(Receiver receiver) {
        Assert.isFalse(receiver == null || receiver.getType() == null
                || CollectionUtils.isEmpty(receiver.getTarget()), "fx.message.client.event.not.receiver");
        this.receiver = receiver;
    }

    public FxMsgEvent putInputs(String key, String val) {
        inputs.put(key, val);
        return this;
    }
