...
public final class TreeFactory {
     ...
     * @return 树
     */
    public static <T> List<T> build(List<T> target, Function<T, Object> idFc, Function<T, Object> pidFc, BiConsumer<T, List<T>> childFc) {
     ...
     * @return 树
     */
    public static <T> List<T> build2(List<T> target, Function<T, Object> idFc, Function<T, Object> pidFc, BiConsumer<T, List<T>> childFc) {
        if (CollectionUtils.isEmpty(target)) {
    ...
    public static <T> List<T> build3(List<T> target, Function<T, Object> idFc, Function<T, Object> pidFc, Function<T, Integer> rankFc, BiConsumer<T, List<T>> childFc) {
        if (CollectionUtils.isEmpty(target)) {
            return Collections.emptyList();
        }
        StopWatch clock = null;
