...
import com.lambda.fusion.dict.domain.vo.ConfigOptionVO;
import com.lambda.fusion.dict.service.ConfigOptionService;
...
public class ConfigOptionController {
     ...
     * @see ConfigOptionVO 配置选项视图对象，定义可更新字段
