...
import com.lambda.fusion.dict.domain.entity.ConfigEntity;
import com.lambda.fusion.dict.domain.entity.ConfigOptionEntity;
import com.lambda.fusion.dict.mapper.ConfigMapper;
import com.lambda.fusion.dict.mapper.ConfigOptionMapper;
import com.lambda.fusion.dict.service.ConfigService;
 ...
 * @see ConfigMapper 配置数据访问接口
 * @see ConfigOptionMapper 配置选项数据访问接口
 */
@Service
...
public class ConfigServiceImpl extends ServiceImpl<ConfigMapper, ConfigEntity> implements ConfigService {
     ...
     *
     * @see ConfigMapper#selectConfigById(String) 自定义ID查询方法
     * @since 1.0.0
     */
    @Override
    @Transactional(propagation = Propagation.NOT_SUPPORTED, rollbackFor = Exception.class)
