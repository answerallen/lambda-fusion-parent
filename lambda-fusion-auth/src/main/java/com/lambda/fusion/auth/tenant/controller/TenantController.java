package com.lambda.fusion.auth.tenant.controller;
...
import com.lambda.fusion.auth.tenant.bean.TenantVO;
import com.lambda.fusion.auth.tenant.service.TenantService;
...
public class TenantController {
    ...
    @Operation(summary = "分页查询所有租户数据列表", description = "分页查询所有数据列表", parameters = {
    ...
    public TenantEntity save( MultipartFile tenantLogo,
    ...
    public TenantEntity update( MultipartFile tenantLogo,
                               @Parameter(description = "租户信息编号", required = true) @PathVariable String id,
                               @Parameter(description = "租户信息信息", required = true) @RequestBody TenantVO entity) {
        LoginUser operator = OperatorUtils.getOperator();
        TenantEntity target = new TenantEntity();
    ...
    public void updateConfig(@Parameter(description = "租户编号", required = true) @PathVariable("id") String id,
