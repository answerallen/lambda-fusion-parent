package com.lamuda.cloud.scaffold.dict.config;

import com.lamuda.cloud.fx.dict.dubbo.RemoteDictService;
...
public class DictionaryConfigure {
    ...
    public static class DictionaryDubboConfigure {
        @Bean
        @ConditionalOnProperty(prefix = "lamuda.fx.dictionary", value = "enable-dubbo-provider",havingValue = "true")
