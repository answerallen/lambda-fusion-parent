package com.lambda.fusion.ai.knowledge.mapper;
...
public interface VectorRepository {
     ...
     */
    void deleteByKbId(
            @Param("dimension") Integer dimension, @Param("kbId") String kbId, @Param("tenantId") String tenantId);
