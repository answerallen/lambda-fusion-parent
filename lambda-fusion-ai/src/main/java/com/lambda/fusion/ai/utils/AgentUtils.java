package com.lambda.fusion.ai.utils;

import static com.lambda.fusion.ai.agent.AgentGraph.CURRENT_NODE_ID_ATTRIBUTE;
import static com.lambda.fusion.ai.agent.AgentGraph.CURRENT_NODE_PROPERTIES_ATTRIBUTE;
    ...
    public AgentState deepCopyState(AgentState original) {
        ...
        if (original.getAttributes() != null) {
            ...
            original.getAttributes().forEach((key, value) -> {
                ...
                if (AgentGraph.AVAILABLE_NODES_ATTRIBUTE.equals(key)) {
                    return;
                }
